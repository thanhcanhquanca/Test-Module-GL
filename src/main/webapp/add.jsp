...
<form id="formMatBang" action="matbang?action=add" method="post" accept-charset="UTF-8" >
...
<script>
  document.getElementById("ngayBatDau").addEventListener("change", function() {
    let ngayBatDau = new Date(this.value);

    if (!isNaN(ngayBatDau)) {
      ngayBatDau.setMonth(ngayBatDau.getMonth() + 6); // Cộng thêm 6 tháng

      let ngayKetThuc = ngayBatDau.toISOString().split('T')[0]; // Định dạng yyyy-MM-dd
